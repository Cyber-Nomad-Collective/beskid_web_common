/**
 * Nav tree builder + helpers, ported from trudoc/src/platform-spec/nav-tree.ts.
 * Replaces platform-spec imports of @cyber-nomad-collective/trudoc/platform-spec/nav-tree.
 */
import type { LayoutLevel, PathClass } from "../layout/schema.js";
...
/** Domains shown in navigation but omitted from hierarchy nav (meta / mapping). */
...
/**
 * Nest flat doc rows into a single root (`platform-spec`) matching
 * domain -> area -> feature -> article.
 */
