...
function hasTourCookie(): boolean {
	...
	return document.cookie
		.split(";")
		.some((entry) => entry.trim().startsWith(`${TOUR_COOKIE_NAME}=`));
}
...
export async function startPlatformSpecMapTour(
	options: PlatformSpecMapTourOptions = {},
): Promise<PlatformSpecMapTourHandle | null> {
