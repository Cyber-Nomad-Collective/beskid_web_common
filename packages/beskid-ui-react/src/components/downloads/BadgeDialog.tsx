...
import type { PlatformId, BadgeStyle, BadgeConfig } from './types';
...
const BADGE_STYLES: BadgeStyle[] = ['flat', 'flat-square', 'plastic', 'for-the-badge', 'social'];
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium" htmlFor="badge-label">Label</label>
            <input
              id="badge-label"
              type="text"
              value={config.label}
          ...
          {/* Color input */}
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium" htmlFor="badge-color">Color</label>
          ...
          <div className="flex flex-col gap-3 border-t border-border pt-3">
            <InstallCommand command={markdownBadge} label="Markdown" badgeLabel="md" />
