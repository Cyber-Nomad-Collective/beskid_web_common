  ...
  return (
    <div className="flex flex-col gap-4">
      {releases.map((release) => (
        <div key={release.version} className="flex flex-col gap-1 border-l-2 border-muted pl-4">
          ...
          {release.changelog && (
            <p className="text-sm text-muted-foreground line-clamp-3">{release.changelog}</p>
          )}
