...
export declare function issueHandoffToken(
	serviceToken: string,
	input: IssueHandoffInput,
): Promise<string>;
export declare function verifyHandoffToken(
	serviceToken: string,
	token: string,
	expectedApp?: AuthAppId,
): Promise<HandoffPayload | null>;
export declare function buildLoginUrl(
	hubPublicUrl: string,
	app: AuthAppId,
): string;
export declare function buildHandoffFinishUrl(
	appPublicUrl: string,
	handoffToken: string,
): string;
