...
function injectAttrs(
	html: string,
	cfg: TrudocHtmlDataAttrsOptions,
	isMapIndex: boolean,
): string {
	let out = html;
 ...
 */
export function createDocAreaHtmlAttrsDevPlugin(
	cfg: TrudocHtmlDataAttrsOptions,
): Plugin {
...
export const createPlatformSpecHtmlAttrsDevPlugin =
	createDocAreaHtmlAttrsDevPlugin;
